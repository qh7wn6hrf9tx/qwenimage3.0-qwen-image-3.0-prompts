# Qwen-Image 3.0 API (qwen-image-3.0 / qwenimage3.0) — prompts guide with published pricing

> **default $0.0206; 1K $0.0206; 2K $0.0206** — flat per-unit billing through the OpenAI-compatible APIMart gateway, $1 minimum top-up.

**[Live pricing](https://go.apimart.ai/k-efb92a)** · **[Get an API key](https://go.apimart.ai/k-e5de65)**
